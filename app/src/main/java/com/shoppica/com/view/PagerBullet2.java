...
public class PagerBullet2 extends FrameLayout {
    ...
    public PagerBullet2(Context context) {
        super(context);
        init(context);
    }

    public PagerBullet2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
        setAttributes(context, attrs);
    }

    public PagerBullet2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setAttributes(Context context, AttributeSet attrs) {
        ...
        if (null != heightValue) {
            ...
            final LayoutParams params = (LayoutParams) indicatorContainer.getLayoutParams();
    ...
    private void init(Context context) {
        ...
        final View rootView = layoutInflater.inflate(R.layout.item_view_pager2, this);
    ...
    public void setPagingEnabled(boolean b) {
        this.viewPager.setPagingEnabled(b);
    }
}
