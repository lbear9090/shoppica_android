...
public class RatingDialog extends AppCompatDialog implements RatingBar.OnRatingBarChangeListener, View.OnClickListener {
    ...
    public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
        ...
        if (ratingBar.getRating() >= threshold) {
            ...
            Prefs.putBoolean(Constants.KEY_ALREADY_RATED, true);
            ...
            AndroidUtilities.runOnUIThread(() -> {
                ...
                builder.ratingThresholdClearedListener.onThresholdCleared(RatingDialog.this, ratingBar.getRating(), thresholdPassed);
            }, 600);


        } else {
            thresholdPassed = false;
            Prefs.putBoolean(Constants.KEY_ALREADY_RATED, false);
            AndroidUtilities.runOnUIThread(() -> {

                if (builder.ratingThresholdFailedListener == null) {
                    setRatingThresholdFailedListener();
                }
                builder.ratingThresholdFailedListener.onThresholdFailed(RatingDialog.this, ratingBar.getRating(), thresholdPassed);
            }, 600);
