package com.shoppica.com.rangeseekbar.widgets;
...
import com.shoppica.com.rangeseekbar.interfaces.OnRangeSeekbarChangeListener;
import com.shoppica.com.rangeseekbar.interfaces.OnRangeSeekbarFinalValueListener;
    ...
    public synchronized boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN: {
                //final int index = event.getPointerCount() - one;
