...
public class TrendingFragment extends BaseFragment implements FeedAdapter.clickListener, SwipeRefreshLayout.OnRefreshListener, NotificationCenter.NotificationCenterDelegate {
    ...
    private boolean mLoading = true, mHasMore = true;
    ...
    private void initViews() {
        ...
        NotificationCenter.getInstance().addObserver(this, NotificationCenter.refreshTrendingFragment);
    ...
    public void onItemClicked(FeedObject mediaObject) {
        ...
        Log.d(TAG,"views == " + mediaObject.getPostViews());
    ...
    public void didReceivedNotification(int id, Object... args) {
        if (id == NotificationCenter.refreshTrendingFragment) {
            setUpFeedData();
            ...
            Log.d(TAG,"updateArticle == "+ postId + " || " + postViews);
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<TrendingFragment> mFragment;


        static final int MESSAGE_GET_FEED = 0;


        MyHandler(TrendingFragment activity) {
        ...
        public void handleMessage(Message msg) {
            final TrendingFragment fragment = mFragment.get();
            if (fragment != null) {
                ...
                switch (msg.what) {
                    ...
                    case MESSAGE_GET_FEED:
                        ...
                        try {
                            ...
                            params.add(Constants.TAB, String.valueOf(0));
    ...
    private static void onErrorGetFeed(TrendingFragment fragment) {
    ...
    public void onDestroy() {
        if (mHandler != null)
            mHandler.removeCallbacksAndMessages(null);
        NotificationCenter.getInstance().removeObserver(this, NotificationCenter.refreshTrendingFragment);
