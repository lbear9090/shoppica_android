...
public class PromotedFragment extends BaseFragment implements FeedAdapter.clickListener, SwipeRefreshLayout.OnRefreshListener, NotificationCenter.NotificationCenterDelegate {

    public static final String TAG = PromotedFragment.class.getSimpleName();
    ...
    private static String PROMOTED = "1";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_promoted, container, false);
    ...
    private void initViews() {
        ...
        NotificationCenter.getInstance().addObserver(this, NotificationCenter.refreshPromotedFragment);
    ...
    public void didReceivedNotification(int id, Object... args) {
        if (id == NotificationCenter.refreshPromotedFragment) {
            setUpFeedData();
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<PromotedFragment> mFragment;


        static final int MESSAGE_GET_FEED = 0;


        MyHandler(PromotedFragment activity) {
        ...
        public void handleMessage(Message msg) {
            final PromotedFragment fragment = mFragment.get();
            if (fragment != null) {
                ...
                switch (msg.what) {
                    ...
                    case MESSAGE_GET_FEED:
                        ...
                        try {
                            ...
                            params.add(Constants.TAB, String.valueOf(2));
                                            ...
                                            try {
                                                ...
                                                if (success == 1) {
                                                    ...
                                                    for (int i = 0; i < userList.length(); i++) {
                                                        ...
                                                        if (postPromoted.equals(PROMOTED)) {
    ...
    private static void onErrorGetFeed(PromotedFragment fragment) {
    ...
    public void onDestroy() {
        if (mHandler != null)
            mHandler.removeCallbacksAndMessages(null);
        NotificationCenter.getInstance().removeObserver(this, NotificationCenter.refreshPromotedFragment);
